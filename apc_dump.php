...
$strBinMd5 = md5_file(APCBIN.'xyws_vn.bin');
...
//        {
//            echo $value,"--",$key,"<br />";
//            if (! apc_bin_dumpfile(array($value), null, APCBIN.'xyws_vn.bin'.$key))
//            {
//                echo $value,"\n";
//            }
//        }
    ...
    return apc_bin_dumpfile($arrCacheFile, array(), APCBIN.'xyws_vn.bin');
}
